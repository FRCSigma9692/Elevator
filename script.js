function calculate_t2() {
    const t2a = document.getElementById("t2a").value*1;
    const t2b = document.getElementById("t2b").value*1;
    const t2e = document.getElementById("t2e").value*1;
    document.getElementById("t2c").innerHTML = t2a - 4;
    document.getElementById("t2d").innerHTML = t2a - 9;
    document.getElementById("t2f").innerHTML = t2a - 12;
    document.getElementById("t2maxext").innerHTML = (t2b * 2) - 0.5;
    document.getElementById("t2total").innerHTML = 4*t2b + t2a + (t2a-4) + (2*(t2a-9)) + (2*(t2a-12)) + (2*(t2e)); 
  }

  function calculate_ts(){
      const tsa = document.getElementById("tsa").value*1;
      const tsb = document.getElementById("tsb").value*1;
